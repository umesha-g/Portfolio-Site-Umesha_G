...
export default function SlugNavbar() {
    ...
    return (
        ...
        <nav className="z-50 bg-neutral-950 fixed top-0 left-0 right-0 pl-10 xl:pr-5 2xl:pr-10 py-2 items-center content-center lg:py-3 2xl:py-4 flex justify-between ">
            ...
            <div ref={ref} className={`md:flex ${isMenuOpen ? 'block' : 'hidden'} border-l-8 lg:border-0 border-red-1 2xl:text-lg justify-end absolute top-0 md:static transition-opacity duration-200 left-0 w-full bg-neutral-950 `}>
            <ul className="flex  flex-col md:mr-24 md:flex-row min-h-screen md:min-h-0 items-center justify-center h-full text-white  bg-neutral-950 ">
                ...
                <motion.li animate={controls} transition= {{duration: 0.6, ease: 'easeInOut', delay:0.20 }} className='my-10  md:my-0'><Link href='/blog/' id='BlogHome' className="hover:text-red-1 2xl:px-8 md:px-6 text-2xl md:text-base 2xl:text-lg transition-colors duration-300 cursor-pointer" onClick={toggleMenu_sectionScroll}>BLOG</Link></motion.li>
