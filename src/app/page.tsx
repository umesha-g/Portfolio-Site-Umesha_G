    ...
    <main className="bg-white">
      <section id='hero' className="bg-slate-900 min-h-screen">
        <div className="relative pt-20">
          <nav ref={navbarRef} className="bg-slate-900 absolute left-0 right-0 px-10 py-2 lg:py-3 2xl:py-4 md:flex md:justify-between">
            <div className="flex justify-center md:justify-start mb-6 md:mb-0">
              <h1 className="text-3xl lg:text-3xl 2xl:text-4xl font-adventbold mr-2 text-amber-600"><a href="#hero">UMESHA</a></h1>
              <h1 className="text-3xl lg:text-3xl 2xl:text-4xl font-adventthin text-amber-600"><a href="#hero">G .</a></h1>
            </div>
     ...
     <section id="services" className='min-h-screen bg-gray-100'>
      ...
      <div>
        <h3 className='text-2xl text-center lg:text-left px-10 lg:py-28 py-32 font-adventbold text-amber-600'>Services I Offer</h3>
      </div>
     ...
     <section id="projects" className='min-h-screen bg-slate-900'>
      ...
      <div>
        <h3 className='text-2xl text-center lg:text-left px-10 lg:py-28 py-32 font-adventbold text-amber-600'>My Projects</h3>
      </div>
      ...
      <section id="contact" className='min-h-screen bg-gray-100'>
        ...
        <div>
          <h3 className='text-2xl text-center lg:text-left px-10 lg:py-28 py-32 font-adventbold text-amber-600'>Contact Me</h3>
        </div>
