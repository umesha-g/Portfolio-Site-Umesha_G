...
export default function Service_Section() {
    ...
    return (
        <AnimatedDivision className='lg:pt-28 pt-20 container mx-auto px-4 overflow-hidden'>
            <h2 className='2xl:text-6xl lg:text-5xl text-4xl font-bold mb-6 lg:mb-10 xl:mb-6 text-center lg:text-left text-red-1'>Services I Offer</h2>
                ...
                <div className='gap-10 pb-20 2xl:pt-10 lg:px-16 mb-5 grid grid-cols-1 lg:grid-cols-2 m-5 '>
                    ...
                    <AnimatedDivision className='text-left xl:m-5 border-red-1 lg:border-b-0 border-b-2 lg:border-l-2  flex xl:flex-row flex-col-reverse '>
                        <div className=' px-6 py-10 lg:p-14'>
                            ...
                            <p className='lg:text-md xl:text-lg 2xl:text-xl  lg:font-light text-neutral-200'> Offering creative and impactful graphic design and branding consultation services, 
                                specializing in modern designs for all brand identity elements. This includes,
                            </p>
                            <div className='p-5 pl-10 justify-between flex lg:text-md xl:text-lg 2xl:text-xl text-neutral-300'>
                            ...
                            <p className='lg:text-md xl:text-lg 2xl:text-xl  lg:font-light text-neutral-200'>Additionally, services extend to the creation of flyers, brochures, posters, and custom orders tailored to
                    ...
                    <AnimatedDivision className='text-left xl:m-5 border-red-1 border-b-2 lg:border-b-0 lg:border-l-2 flex xl:flex-row flex-col-reverse'>
                        <div className='  px-6 py-10 lg:p-14'>
                            ...
                            <p className='lg:text-md xl:text-lg 2xl:text-xl  lg:font-light text-neutral-200'>Providing comprehensive software development and engineering services focused on delivering innovative and efficient solutions.
                            ...
                            <p className='lg:text-md xl:text-lg 2xl:text-xl  lg:font-light text-neutral-200'>
