                    ...
                    <div className='gap-10 pb-20 lg:pt-10 lg:px-16 mb-5 grid grid-cols-1 lg:grid-cols-2 m-5 '>
                        ...
                        <AnimatedDivision className='text-left xl:m-5 border-red-1 lg:border-b-0 border-b-2 lg:border-l-2  flex xl:flex-row flex-col-reverse '>
                            <div className=' p-10 lg:p-14'>
                                <h1 className='text-2xl font-semibold text-white mb-10'>Graphic Designing</h1>
                                <p className='text-lg text-neutral-400'> Offering creative and impactful graphic design and branding consultation services, 
                                    specializing in modern designs for all brand identity elements. This includes,
                                </p>
                                <div className='p-5 pl-10 justify-between flex text-lg text-neutral-400'>
                                ...
                                <p className='text-lg text-neutral-400'>Additionally, services extend to the creation of flyers, brochures, posters, and custom orders tailored to
                        ...
                        <AnimatedDivision className='text-left xl:m-5 border-red-1 border-b-2 lg:border-b-0 lg:border-l-2 flex xl:flex-row flex-col-reverse'>
                            <div className=' p-10 lg:p-14'>
                                <h1 className='text-2xl font-semibold text-white mb-10'>Software Developing</h1>
                                <p className='text-lg text-neutral-400'>Providing comprehensive software development and engineering services focused on delivering innovative and efficient solutions.
