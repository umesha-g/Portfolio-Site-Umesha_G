      ...
      <nav className={`z-50 bg-neutral-950 fixed top-0 left-0 right-0 pl-10 xl:pr-5 2xl:pr-10 py-2 items-center content-center lg:py-3 2xl:py-4 flex justify-between`}>
        ...
        <div ref={ref} className={`lg:flex ${isMenuOpen ? 'block' : 'hidden'} border-l-8 lg:border-0 border-red-1 2xl:text-lg justify-end absolute top-0 lg:static left-0 w-full bg-neutral-950 `}>
          <ul className={` flex flex-col lg:mr-24 lg:flex-row text-center min-h-screen lg:min-h-0 items-center justify-center h-full text-white  bg-neutral-950 `}>
            <motion.li animate={controls} transition= {{duration: 0.4, ease: 'easeInOut', delay:0.05 }} className='my-8  lg:my-0'><Link href="#" id='about_bt' section-id="about_sc" className="hover:text-red-1 2xl:px-8 lg:px-6 text-xl lg:text-base 2xl:text-lg transition-colors duration-300 cursor-pointer" onClick={toggleMenu_sectionScroll}>ABOUT</Link></motion.li>
            <motion.li animate={controls} transition= {{duration: 0.4, ease: 'easeInOut', delay:0.10 }} className='my-8  lg:my-0'><Link href="#" id='service_bt' section-id="services_sc" className="hover:text-red-1 2xl:px-8 lg:px-6 text-xl lg:text-base 2xl:text-lg transition-colors duration-300 cursor-pointer" onClick={toggleMenu_sectionScroll}>SERVICES</Link></motion.li>
            <motion.li animate={controls} transition= {{duration: 0.4, ease: 'easeInOut', delay:0.15 }} className='my-8  lg:my-0'><Link href="#" id='project_bt' section-id="projects_sc" className="hover:text-red-1 2xl:px-8 lg:px-6 text-xl lg:text-base 2xl:text-lg transition-colors duration-300 cursor-pointer" onClick={toggleMenu_sectionScroll}>PROJECTS</Link></motion.li>
            <motion.li animate={controls} transition= {{duration: 0.4, ease: 'easeInOut', delay:0.20 }} className='my-8  lg:my-0'><Link href="#" id='contact_bt' section-id="test_sc" className="hover:text-red-1 2xl:px-8 lg:px-6 text-xl lg:text-base 2xl:text-lg transition-colors duration-300 cursor-pointer" onClick={toggleMenu_sectionScroll}>TESTIMONIALS</Link></motion.li>
            <motion.li animate={controls} transition= {{duration: 0.4, ease: 'easeInOut', delay:0.20 }} className='my-8  lg:my-0'><Link href='/blog' id='blog' className=" 2xl:px-8 lg:px-6 text-xl lg:text-base 2xl:text-lg transition-colors duration-300 cursor-pointer" onClick={toggleMenu_sectionScroll}><div className='lg:bg-red-1 lg:-my-8 lg:px-4 lg:ml-6 lg:py-1 bg-transparent hover:lg:bg-red-900 rounded-sm'><h1>BLOG</h1></div></Link></motion.li>
            <motion.li animate={controls} transition= {{duration: 0.4, ease: 'easeInOut', delay:0.25 }} className='my-8  lg:my-0 lg:hidden'><Link href="#" id='close' className="lg:px-8 text-4xl mr-2 text-red-1" onClick={toggleMenu_sectionScroll}><HiX/></Link></motion.li>
          </ul>
        </div>
