...
export default function Navbar() {
  ...
  return (
    <div className="relative z-50">
      <nav className={`${styles.navbarback} bg-ebony-950 fixed top-0 left-0 right-0 pl-10 xl:pr-5 2xl:pr-10 py-2 items-center lg:py-3 2xl:py-4 flex justify-between z-10`}>
        ...
        <div ref={ref} className={`md:flex ${isMenuOpen ? 'block' : 'hidden'} 2xl:text-lg justify-end absolute top-0 md:static left-0 w-full bg-ebony-950 `}>
          <ul className={`${styles.navbarback} flex flex-col md:mr-24 md:flex-row min-h-screen md:min-h-0 items-center justify-center h-full text-white  bg-ebony-950 `}>
