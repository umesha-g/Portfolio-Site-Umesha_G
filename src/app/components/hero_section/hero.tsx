...
export default function Hero() {
    ...
    return (
        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 lg:mx-10 mx-0  '>
          ...
          <AnimatedDivision className= 'pt-5 lg:pt-10 xl:pt-0 2xl:pt-2 mx-12 lg:ml-24 2xl:ml-44  lg:flex '>
            <div className='mt-24 lg:mt-44 xl:mt-52 2xl:mt-96'>
              ...
              <div className='text-center lg:text-left '>
                <h3 className='text-white text-md lg:text-xl 2xl:text-2xl -mb-4'>Hello there, I am</h3>
                <h2 className='font-jost text-red-1 text-3xl sm:text-4xl md:text-5xl font-black lg:text-6xl xl:text-6.5xl my-5 2xl:text-7xl'>Umesha Madushan</h2>
                <h3 className='text-white text-md lg:text-xl 2xl:text-2xl -mt-4'>Developer and Designer <br className='lg:hidden'/> from  Sri Lanka </h3>
              </div>
          ...
          <AnimatedDivision className='container justify-self-center object-contain block'>
            <div className='xl:relative ml-10 xl:ml-0 block'>
