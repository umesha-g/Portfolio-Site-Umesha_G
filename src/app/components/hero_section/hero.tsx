          ...
          <NoBorderdAnimatedDivision className= 'pt-5 lg:pt-0 mx-12 lg:ml-24 2xl:ml-44 lg:mx-20 lg:flex '>
            <div className='mt-20 lg:mt-44 2xl:mt-80'>
              ...
              <div className='text-center lg:text-left'>
                ...
                <h2 className='  leading-8 font-backto text-thatch-green-500 text-3xl sm:text-5xl my-5 2xl:text-6xl'>Umesha Madushan</h2>
                <h3 className='text-white lg:text-lg 2xl:text-2xl'>Developer and Designer <br className='lg:hidden'/> from  Sri Lanka </h3>
              </div>

              <div className=' flex pt-5 justify-center lg:justify-start text-3xl 2xl:text-4xl text-thatch-green-500 mb-10 lg:mb-10 ' >
