...
import Time_Line from './about_time';
  ...
  return (
    <div className=" lg:py-28 py-20">
      <div className="container mx-auto px-4 overflow-hidden">
        ...
        <div className="relative border-2 flex-col flex-wrap justify-start justify-items-start border-thatch-green-500 rounded-lg p-10 mb-10">
