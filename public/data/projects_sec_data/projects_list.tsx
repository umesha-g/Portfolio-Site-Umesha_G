...
export const projects_list: Project[] = [
  {
    title: 'Next.js Blog',
    description: 'A responsive blog built with Next.js and Tailwind CSS aaaaaaaa aaaaaaaa aaaaaaaa aaaaaaa aaaaaaaa aaaaaaaa aaaaaaa aaaaaaaa aaaaaaaa ',
  ...
  },
  {
    ...
    description: 'Full-stack e-commerce solution with Next.js, MongoDB, and Stripe',
   // imageUrl: '/images/ecommerce-project.jpg',
    projectUrl: ['block','https://google.com'],
    githubUrl: 'https://github.com/yourusername/nextjs-ecommerce'
  }
];